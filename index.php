...
<html>
	<head>
		...
		<link rel="stylesheet/less" type="text/css" href="style/screen.less" />
		<script type="text/javascript" src="scripts/less-1.2.1.min.js"></script>
		<!--<link rel="stylesheet" type="text/css" href="style/getLess.php?screen" />-->
...
-->
		...
		<script type="text/javascript" src="scripts/jquery.opensource.js"></script>
		<script type="text/javascript">
			...
			OPENSOURCE.init($.sfbrowser,function(){
...
//				});
//				////////////////////////////// test dropbox safari
//				var x = $('<div>...</div>').appendTo($('body')).css({
//					position:'absolute'
//					,left:0
//					,top:0
//					,width:100
...
//					console.log('drop',e.type,e.originalEvent.dataTransfer.files.length||-1,e); // log
//				});
//				console.log('x',x); // log
//				//
//				$.sfb({select:addFiles,plugins:['createascii'],bgcolor:'#CEE9F4',bgalpha:.8}); // todo: rem
//				/////////////////////////////////////
			});
...
<!--		<script src="http://www.sjeiti.com/ga.js" type="text/javascript"></script>-->
	...
	<body>
		...
		<section id="intro">
			<div>
				<div>
					<p>SFBrowser is a file browser and uploader. It returns a list of objects with containing the names and additional information of the selected files.<br/>
					...
					<img src="data/screenshot.jpg" alt="screenshot" />

					<p>You can download as <a href="http://code.google.com/p/sfbrowser/downloads">zip</a> or do a <a href="http://sfbrowser.googlecode.com/svn/trunk">repository checkout</a>. If you stumble upon anything out of the ordinary you can <a href="http://code.google.com/p/sfbrowser/issues">file them here</a>.</p>

					<p>SFBrowser is also available as a <a href="http://wordpress.org/extend/plugins/sfbrowser/" rel="nofollow">Wordpress plugin</a>:<br/>
					<a href="download/jquery.sfbrowser.1.1.2.zip" class="button download wordpress"><span></span> <span class="filesize"></span> Wordpress plugin<br/><!--<small>including examples / excluding movies</small>--></a></p>

				</div>
				<aside>
					<h3>download</h3>
					<a href="download/jquery.sfbrowser.1.1.1.zip" class="button download"><span class="iconic download"></span> <span class="filesize"></span> full zip<br/><small>including examples / excluding movies</small></a>
					<a href="http://sfbrowser.googlecode.com/svn/trunk" class="repo" data-type="svn" rel="external" target="_blank">http://sfbrowser.googlecode.com/svn/trunk</a>
					<!--<p>If you stumble upon anything out of the ordinary you can <a href="http://code.google.com/p/tinysort/issues">file them here</a>.</p>-->
...
&lt;/script&gt;</pre>
	...
	,height:	&lt;uint&gt;		image height in pixels
				...
				<h3 title="fileList">_POST["a"]=="fileList" :: retreive file list</h3>
				<pre>input:
...
example: {
	...
	data: {
		...
		...
				...
				<h3 title="upload">_POST["a"]=="upload" :: file upload</h3>
				<pre>input:
...
output: JSON {
	...
	,data:		&lt;FileObject&gt;	uploaded file
				...
				<h3 title="duplicate">_POST["a"]=="duplicate" :: duplicate file</h3>
				<pre>input:
...
output: JSON {
	...
	,data:		&lt;FileObject&gt;	duplicated file
				...
				<h3 title="delete">_POST["a"]=="delete" :: file delete</h3>
				<pre>input:
	_POST["file"]	&lt;String&gt;	file name
	_POST["folder"]	&lt;String&gt;	file folder
action:
...
output: JSON {
	...
	,msg:		&lt;String&gt;	succes message (see lang.js)
				...
				<h3 title="download">_POST["a"]=="download" :: file force download</h3>
				<pre>input:
	_POST["file"]	&lt;String&gt;	file name
	_POST["folder"]	&lt;String&gt;	file folder
action:
...
output: nothing</pre>
				...
				<h3 title="read">_POST["a"]=="read" :: read txt file contents</h3>
				<pre>input:
	_POST["file"]	&lt;String&gt;	file name
	_POST["folder"]	&lt;String&gt;	file folder
action:
...
output: JSON {
	...
	,data: {
		text:	&lt;String&gt;	first x amount of bytes from ascii file
				...
				<h3 title="rename">_POST["a"]=="rename" :: rename file</h3>
				<pre>input:
...
output: JSON {
	...
	,msg:		&lt;String&gt;	succes message (see lang.js)
				...
				<h3 title="addFolder">_POST["a"]=="addFolder" :: add folder</h3>
				<pre>input:
...
output: JSON {
	...
	,data:		&lt;FileObject&gt;	newly created folder
				...
				<h3 title="bar">_POST["a"]=="bar" :: image resize (in imageresize plugin)</h3>
				<pre>input:
	_POST["file"]	&lt;String&gt;	file name
	_POST["folder"]	&lt;String&gt;	file folder
...
output: JSON {
	...
	,msg:		&lt;String&gt;	succes message (see lang.js)
		...
		<footer>
			<div>© 2011-2011 <a href="http://www.sjeiti.com/">Ron Valstar</a></div>
		</footer>
	</body>
</html>